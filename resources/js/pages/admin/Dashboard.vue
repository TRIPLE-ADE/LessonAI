    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ questionsCount }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Recent Lessons</h3>
                    <div class="flow-root">
                        <ul class="-my-5 divide-y divide-gray-200">
                            <li v-for="lesson in lessons.slice(0, 5)" :key="lesson.id" class="py-4">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="flex-shrink-0">
                                        <Link :href="route('admin.lessons.show', lesson.id)" 
